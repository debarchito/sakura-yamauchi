  ...
  for x in -5..5 {
    for z in -5..5 {
      ...
      commands.spawn((
        ...
        Transform::from_xyz(x as f32 * 2.0, 0.0, z as f32 * 2.0).with_scale(Vec3::splat(scale)),
        Bouncing,
      ));
    }
  }
...
fn update_bloom_settings(
  ...
  match bloom {
    (entity, Some(mut bloom)) => {
      ...
      bloom.low_frequency_boost_curvature = bloom.low_frequency_boost_curvature.clamp(0.0, 1.0);
